        ...
        <>
            <Layout>
                <div style={{ display: isHidden ? 'none' : 'block' }}>
                    ...
                    <Button className="button" variant="danger" onClick={handleDelete} style={{ width: "200px", margin: "auto" }}>Delete</Button>
                    <Modal show={showConfirmModal} onHide={() => setShowConfirmModal(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title>Confirm deletion</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>Are you sure you want to delete this component?</Modal.Body>
                        <Modal.Footer>
